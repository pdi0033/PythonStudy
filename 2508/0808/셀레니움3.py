...
# 3. submit 버튼을 찾아서 이벤트를 발생시킨다.
button = driver.find_element(By.NAME, "submit")
button.click()      # 버튼 눌림 이벤트 => click 이벤트 핸들러가 submit()을 호출함.
...
driver.save_screenshot("python_event.png")      # 화면 캡처 후 파일저장

# 다음 페이지로 이동하기
#content > div > section > form > div > a
driver.set_window_size(800, 600)
next = driver.find_element(By.CSS_SELECTOR, "#content > div > section > form > div > a")
next.click()

time.sleep(5)
#content > div > section > form > div > a:nth-child(2)
# //*[@id="content"]/div/section/form/div/a
