...
def deeplearning():
    ...
    # 미세조정
    conv_base.trainable = True
    for layer in conv_base.layers[:-4]:      # 상위 4계층만 다시 훈련하게 한다.
        layer.trainable = False     # 하위 계층 동결
    # 학습률을 아주 낮춰서 학습을 해야 한다..
    # optimizer 에 단순 rmsprop를 하면 안 된다.
    ...
    with open("개와고양이사전학습3.bin", "wb") as file:
