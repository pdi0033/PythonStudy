...
model = keras.Sequential([
    ...
    layers.Dense(10, activation='softmax')  # 출력값의 개수, 활성화함수
...
train_images = train_images.reshape(train_images.shape[0], 28 * 28) # 3차원을 2차원으로
train_images = train_images.astype(float) / 255     # 스케일링

test_images = test_images.reshape(test_images.shape[0], 28 * 28) # 3차원을 2차원으로
